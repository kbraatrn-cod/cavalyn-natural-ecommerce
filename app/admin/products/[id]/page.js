...
export default function AdminEditProductPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        addToast(data.error || 'Ürün güncellenemedi', 'error');
      }
    } catch (error) {
  ...
  if (loading) {
    return <div className="admin-loading"><div className="loader" /></div>;
  }
      ...
      <form onSubmit={handleSubmit} className="admin-form">
        <div className="admin-form__grid">
          ...
          <div className="admin-form__section">
            ...
            <div className="admin-form__group">
              <label className="admin-form__label">Etiketler</label>
              <input
                type="text"
                name="tags"
                value={form.tags}
